...
function create_Arrow_for_Vector(segment_points , geometric_data_object,
                ...
                if (eval(arrow_at_end)) 
                            {addCone(adjustedend_point.add(direction.scale(coneHeight / 2))                    , direction)}

                if (eval(arrow_at_start_point)) 
                            {addCone(adjustedstart_point.subtract(direction.scale(coneHeight / 2))             , direction.negate())}
